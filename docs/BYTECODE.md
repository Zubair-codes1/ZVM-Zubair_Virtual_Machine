...
The .bin file is created by the assembler (or Zembler) when it parses the .txt file, and it
...
│  INSTRUCTIONS   │   N x 8 bytes, one record per instruction
└─────────────────┘
```
---
### **Header**
...
|---------------------|--------------|------------------------------------------------------------------------------------------------------------|--------------------------------|
| Magic Number        | 2            | Identifies the file as ZVM binary. Required for the program to run.                                        | CA FE                          |
...
| Instruction Count   | 4            | Number of 8 byte instructions in the actual part of the program.                                           | 00 00 00 32  (50 instructions) |
...
For example, the instruction "PUSH 100" would be represented as: 10 00 00 00 00 00 00 64.
Another example with "HALT" which takes no operands: 00 00 00 00 00 00 00 00
...
; Instructions
10 00 00 00 00 00 00 64 ; PUSH 100
51 00 00 00 00 00 00 00 ; STORE secret - since secret is the first and only constant it is represented by 0
43 00 00 00 00 00 00 06 ; CALL :testlogic - since testlogic is declared after 6 instructions, its operand is 6
50 00 00 00 00 00 00 00 ; LOAD secret
61 00 00 00 00 00 00 00 ; PRINT_CHAR - takes no operand so operand set to 0
00 00 00 00 00 00 00 00 ; HALT - takes no operand as well
10 00 00 00 00 00 00 0A ; PUSH 10
53 00 00 00 00 00 00 00 ; STORE_LOCAL 0 - since operand of STORE_LOCAL is 0 it is also represented as 0 in binary
27 00 00 00 00 00 00 00 ; INC_LOCAL 0
52 00 00 00 00 00 00 00 ; LOAD_LOCAL 0
60 00 00 00 00 00 00 00 ; PRINT - takes no operand
44 00 00 00 00 00 00 00 ; RET
```