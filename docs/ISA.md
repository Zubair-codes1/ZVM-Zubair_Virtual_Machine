...
| PUSH_STR    | 0x15      | Constant pool index        | [a, b] -> [a] (pops address and reads string at the address)             |                                           |
...
| ALLOC       | 0x54      | Size of memory to allocate | [a, b] -> [a, b, c] (pushes address of allocated bytes)                  | Byte amount not provided error            |
| LOAD_HEAP   | 0x55      | Offset                     | [a, b] -> [a, c] (pops address but pushes the value at address + offset) | Underflow                                 |
| STORE_HEAP  | 0x56      | Offset                     | [a, b] -> [] (where a is the address and b is the value)                 | Underflow                                 |
...
| PRINT_STR   | 0x63      | None                       | [a, b] -> [a, b] (prints the string at index b)                          | Underflow and invalid ASCII               |
